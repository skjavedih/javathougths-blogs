...
A demo of a multiple authors post is shown in [Introducing Tailwind Nextjs Starter Blog post](/blog/introducing-javathoughts-blogs).
...
Line highlighting and line numbers are now supported out of the box thanks to the new [rehype-prism-plus plugin](https://github.com/skjavedih/rehype-prism-plus)
...
See [rehype-citation readme](https://github.com/skjavedih/rehype-citation) for more information on the configuration options.
...
```bash
git remote add template git@github.com:skjavedih/javathoughts-blogs.git
git pull template v1 --allow-unrelated-histories
rm -rf node_modules
```

You can see an example of such a migration in this [commit](https://github.com/skjavedih/skjavedih.com/commit/bba1c185384fd6d5cdaac15abf802fdcff027286) for my personal blog.
