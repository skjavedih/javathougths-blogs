...
The template was first released in January 2021 and has since been used by thousands of users. It is featured on [Next.js Templates](https://vercel.com/templates/next.js/tailwind-css-starter-blog), [Tailwind Awesome](https://www.tailwindawesome.com/resources/javathoughts-blogs) among other listing sites. It attracts 200+ unique visitors daily notching 1500-2000 page views, with 1.3k forks and many other clones.
...
To solve this, I have abstracted the logic to a separate repository - [Pliny](https://github.com/skjavedih/pliny). Pliny provides out of the box Next.js components to enhance static sites:
...
I hope you enjoy the new features and improvements in V2. If you have any feedback or suggestions, feel free to open an issue or reach out to me on [Twitter](https://twitter.com/skjavedih).

## Support

Using the template? Support this effort by giving a star on GitHub, sharing your own blog and giving a shoutout on Twitter or be a project [sponsor](https://github.com/sponsors/skjavedih).

## Licence

[MIT](https://github.com/skjavedih/javathoughts-blogs/blob/main/LICENSE) © [Timothy Lin](https://www.timrlx.com)
