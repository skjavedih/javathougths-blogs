...
> _Can we simplify concurrency without sacrificing reliability at Netflix scale?_
...
- Instances appearing _alive_ but serving no traffic
...
To operators, the service looked _frozen_.
...
- It stays _pinned_ to its carrier OS thread
...
Even _small_ synchronized sections became catastrophic under load.
...
### If You Are _Not_ Netflix-Scale
