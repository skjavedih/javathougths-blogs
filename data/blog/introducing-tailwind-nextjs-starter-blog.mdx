...
1. JS (official support) - `npx degit https://github.com/skjavedih/javathoughts-blogs.git` or TS (community support) - `npx degit skjavedih/javathoughts-blogs#typescript`
